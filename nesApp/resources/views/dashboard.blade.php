                                        ...
                                        <div class="top-status">
                                            ...
                                            <ul>
                                                @foreach ($bills as $bill)
                                                    <li class="active orders" data-bill-id="{{ $bill->id }}"
                                                        id="orders-{{ $bill->id }}">
                                                        ...
                                                        @elseif ($bill->orders->every(fn($order) => $order->status === 'ship'))
                                                            <svg id="Layer_1" enable-background="new 0 0 512 512"
                                                                height="50" viewBox="0 0 512 512" width="50"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <g clip-rule="evenodd" fill-rule="evenodd">
                                                                    <path
                                                                        d="m282.35 231.57h210.61c4.42 0 8.04 3.62 8.04 8.04v184.77c0 4.42-3.62 8.04-8.04 8.04h-210.61c-4.42 0-8.04-3.62-8.04-8.04v-184.77c0-4.42 3.62-8.04 8.04-8.04z"
                                                                        fill="#fcd770" />
                                                                    <path
                                                                        d="m423.31 230.95v77.74l-35.66-23.5-35.65 23.5v-77.74z"
                                                                        fill="#fc6e51" />
                                                                    <path
                                                                        d="m272.08 409.53-109.97 24.31c-3.7.82-7.24-.58-9.38-3.71l-24.2-35.42-25.23-59.61c-.43-1.02-1.61-1.49-2.63-1.06-1.01.43-1.48 1.61-1.06 2.62l24.6 58.08-89.58 45.76-20.86-114.26c-1.14-6.26-.48-12.66 2.13-18.48s6.96-10.57 12.39-13.88l58.56-35.68 30.67 42.67c.38.53.99.83 1.63.83.31 0 .61-.07.89-.21l42.09-21.06 26.91 46.85c.36.62 1.01 1 1.73 1 .09 0 .18-.01.27-.02.81-.11 1.47-.69 1.67-1.48l12.27-48.06 29.15 22.57c.35.27.78.42 1.22.42.24 0 .48-.05.71-.13.64-.24 1.12-.8 1.26-1.48l9.86-48.92 24.9 17.26z"
                                                                        fill="#fc6e51" />
                                                                    <path
                                                                    ...
                                                                    <g fill="#f0d0b4">
                                                                        ...
                                                                        <path
                                                                            d="m88 131.51c2.7 7.81 5.66 15.55 8.98 23.12l1.94 4.42-4.7 1.08c-8.26 1.9-17.08-2.18-20.05-10.31-1.54-4.23-1.22-8.81.77-12.84 1.61-3.26 4.18-5.91 7.35-7.68l4.17-2.31z" />
                                                                    </g>
                                                                    <path
                                                                        d="m86.03 112.29c-4.84-18.01-6.46-38.19.8-55.79 6.81-16.49 20.04-27.29 36.77-33.04 16.22-5.58 35.01-5.96 51.53-1.54 13.74 3.68 29.05 11.75 34.81 25.56 2.09 5 4.01 10.06 5.75 15.19l1.79 5.29h-26.72c-14.77 0-27.68 6.5-36.49 18.36l-21.87 29.45h-46.37z"
                                                                        fill="#fc6e51" />
                                                                    <path
                                                                        d="m157.49 88.7c8.1-10.91 19.69-16.74 33.28-16.74h30.44l-28.53 30.61c-8.12 8.72-18.41 13.19-30.33 13.19h-24.95zm65.37-16.74h14.47c12.95 0 24.19 5.38 32.31 15.47l7.04 8.76c1.12 1.42 1.42 3.12.88 4.81-.52 1.72-1.76 2.95-3.52 3.46l-43.86 12.87-.31-5c-.75-11.96-2.7-23.77-5.71-35.37z"
                                                                        fill="#fcd770" />
                                                                    <path
                                                                        d="m162.98 437.75 164.83-36.44c3.32-.73 6.46-.03 9.15 2.06 2.7 2.1 4.19 4.96 4.27 8.39l.02.68c.17 4.75-2.57 9.64-7.44 10.8l-53.35 12.67c-1.01.24-1.66 1.18-1.52 2.21.14 1.01 1.03 1.77 2.05 1.73l95.5-3.33 4.63-.02.3.05c2.3.34 4.27 1.37 5.94 2.99 2.26 2.2 3.38 4.87 3.35 8.01v.22c-.06 5.71-4.35 10.47-10.08 10.88l-83.1 5.96c-21.63 1.55-42.98 5.14-64.1 10.03-19.96 4.62-39.6 10.37-59.18 16.37-5.69 1.74-10.86 1.89-16.74 2.01-.81.02-1.61.04-2.42.06-13.15.36-23.35-6.49-33.22-14.41l-59.6-47.78 63.88-32.62 23.31 34.13c3.05 4.5 8.19 6.53 13.52 5.35z"
                                                                        fill="#f0d0b4" />
                                                                    <path
                                                            ...
                                                            <tbody>
                                                                @foreach ($bill->orders as $order)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $order->size }}</td>
                                                                        <td
                                                                            style="  font-size: clamp(10px, 5vw, 14px);">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <strong style="color: #06C167">-
                                                                            ${{ $bill->discount_amount }}</strong>
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <span>Hóa đơn: {{ $bill->created_at }} | Giá trị : {{ $bill->discount_total }}</span>
                        ...
                        <div id="addressBook" class="card" style="display: none;">
                            <div class="card-body">
                                ...
                                @foreach ($receivers as $receiver)
                                    <input style="width:10px;" type="radio" name="receiver" class="rec-radio"
                                        data-name="{{ $receiver->fullname }}" data-phone="{{ $receiver->phone }}"
                                        data-address="{{ $receiver->address }}">{{ $receiver->fullname }} -
                                    {{ $receiver->address }} - {{ $receiver->phone }}
                                @endforeach
