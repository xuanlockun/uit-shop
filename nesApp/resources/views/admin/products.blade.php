...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  <style>
    ...
    .modal-footer {
        display: flex !important; /* Dùng !important để ghi đè */
  ...
  <body>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="#addproductModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New customer</span></a>
    ...
    <script>$(document).ready(function(){
        ...
        var sizes = button.data('sizes'); // Get the sizes as a string like "Small - 10, Medium - 15"
        ...
        modal.find('.form-control[name="sizes"]').val(sizes); // Show the sizes in a text input or textarea
