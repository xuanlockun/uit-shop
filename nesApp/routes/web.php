...
Route::group(['middleware' => ['auth']], function () {
    Route::group(['middleware' => function ($request, $next) {
        if (auth()->user()->email !== 'xuanlockun594@gmail.com') {
        ...
        Route::get('/admin/products', [AdminController::class, 'product'])->name('admin.products');
        ...
        Route::put('/bills/{id}', [OrderController::class, 'update'])->name('bills.update');
        Route::delete('/bills/{id}', [CouponController::class, 'destroy'])->name('bills.destroy');
        Route::post('/admin/products', [AdminController::class, 'productstore'])->name('products.store');
        ...
        Route::post('/admin/sizes', [AdminController::class, 'sizestore'])->name('sizes.store');
